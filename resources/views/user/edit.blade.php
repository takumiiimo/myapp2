                ...
                <form class="edit_user" enctype="multipart/form-data" action="/users/update" accept-charset="UTF-8" method="post">
                    ...
                    <div class="form-group">
                        ...
                        @if ($user->profile_photo )
                            <p>
                                <img src="{{ secure_asset('storage/user_images/' . $user->profile_photo) }}" alt="avatar" />
                            </p>
                        @endif 
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="gender" value="{{ old('user_gender',$user->gender) }}" name="user_gender" >
                          <option>man</option>
                          <option>woman</option>
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="aria">活動場所</label>
                        <input autofocus="autofocus" class="form-control" type="text" value="{{ old('user_aria',$user->aria) }}" name="user_aria" />
                    </div>
                    
                    <div class="form-group">
                        <label for="introduction">自己紹介</label>
                        <textarea autofocus="autofocus"class="form-control" type="text" value="{{ old('user_introduction',$user->introduction) }}" name="user_introduction" ></textarea>
                    </div>
