    ...
    <div class="d-flex flex-column align-items-center mt-3">
        <div class="col-xl-7 col-lg-8 col-md-10 col-sm-11 post-card">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="upload-images p-0 border-0" id="new_post" enctype="multipart/form-data" action="{{ url('/creator/posts')}}" accept-charset="UTF-8" method="POST">
                        {{ csrf_field() }}
                        <div class="form-group row mt-2">
                            <div class="col-auto pr-0">
                                <img class="post-profile-icon round-img" src="{{ secure_asset('storage/user_images/' . Auth::user()->id.'.jpg') }}"/>
                            </div>
                            <div class="col pl-0">
